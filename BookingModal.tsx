    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-[3rem] w-full max-w-lg overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.25)] border border-white/50 max-h-[90vh] overflow-y-auto animate-in relative z-10 ring-1 ring-black/5">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8 bg-white">
          {!isOwner && (
            <div className="bg-slate-100 p-4 rounded-2xl border border-slate-200 text-slate-600 flex gap-3 text-xs font-medium">
              <div className="text-slate-400"><Icons.Lock /></div>
              ...
              {initialData && (
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="flex-1 py-3 px-4 bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366] hover:text-white rounded-xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-2 border border-[#25D366]/20"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 py-3 px-4 bg-slate-100 text-slate-600 hover:bg-slate-800 hover:text-white rounded-xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-2 border border-slate-200"
                  >
                    <Icons.Phone />
                    Call
                  </button>
